        ...
        <div className="container mx-auto h-full flex flex-col justify-center px-6 lg:px-12">
          <div className="max-w-2xl">
            ...
            <div className="flex flex-wrap gap-3 mb-6">
              ...
              <button className="flex items-center gap-2 bg-gray-600/70 text-white px-6 py-3 rounded-md font-bold text-base hover:bg-gray-600/90 transition-colors backdrop-blur-sm">
