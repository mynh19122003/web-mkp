        ...
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <nav className="hidden lg:flex items-center space-x-8">
            ...
            <div className="relative group">
              <button className="text-white hover:text-gray-300 transition-colors flex items-center font-medium">
                Thể loại
            ...
            <Link href="/phim-le" className="text-white hover:text-gray-300 transition-colors font-medium">
              Phim lẻ
            </Link>
            <Link href="/phim-bo" className="text-white hover:text-gray-300 transition-colors font-medium">
              Phim bộ
            </Link>
            <Link href="/top-imdb" className="text-white hover:text-gray-300 transition-colors font-medium">
              Top IMDb
            </Link>
          </nav>
          ...
          <div className="hidden lg:flex items-center space-x-6">
            ...
            <div className="relative">
              <input
                ...
                className="bg-black bg-opacity-40 border border-gray-700 text-white pl-4 pr-10 py-2.5 rounded-full focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent w-80 placeholder-gray-400 backdrop-blur-sm"
              />
            ...
            <div className="relative group">
              ...
              <div className="absolute right-0 mt-3 w-48 bg-black bg-opacity-95 backdrop-blur-md rounded-lg shadow-2xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 border border-gray-800">
                <div className="p-2">
                  ...
                  <button className="w-full text-left px-3 py-2 text-sm text-gray-300 hover:bg-red-600 hover:bg-opacity-20 hover:text-white rounded-md transition-colors">
                    Đăng xuất
                  </button>
                </div>
              </div>
